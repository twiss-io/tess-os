...
<!-- Rendered by `tessctl render --target codex` from .tess/core/commands/review-mission.md. Regenerate; do not hand-edit. -->

Tess OS command `/review-mission`, packaged as an Agent Skill. Run it only when the user asks for it by name (`$tess-review-mission` in Codex).
