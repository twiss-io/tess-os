"""Command-line wrapper for the advisory connector-manifest validator.
...
from .manifest_validator import validate_repository


def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        description="Validate local advisory connector manifests without changing the checkout."
    )
