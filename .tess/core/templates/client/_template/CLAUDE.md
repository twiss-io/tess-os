# [Client Name] — {{ASSISTANT_NAME}} Client Operating File
...
[1-2 paragraph description of the client, their business, what they do, and why they're working with the operator/{{ASSISTANT_NAME}}.]

---

## What {{ASSISTANT_NAME}} Does For This Client

[Description of {{ASSISTANT_NAME}}'s role with this client — mission types, outcomes being pursued.]
...
- **Known sensitivities:** [Anything {{ASSISTANT_NAME}} should know about handling this client's context]
...
```
[client-name]/
├── CLAUDE.md          ← this file — {{ASSISTANT_NAME}}'s operating brief for this client
├── admin/
...
│   └── [repo-name]/
└── kb/                ← the agency Knowledge Base ({{ASSISTANT_NAME}}-maintained)
...
**Ingest new material:** Drop files in kb/raw/ and tell {{ASSISTANT_NAME}}: "Ingest new sources for [Client Name]."
**Lint pass:** Tell {{ASSISTANT_NAME}}: "Run a lint pass on [Client Name]'s wiki."
