...
> **{{ASSISTANT_NAME}} may only:** read doctrine files (canonical whitelist: [conductor/guardrails.md](conductor/guardrails.md) Rule 1), report to the operator in the active session, and do brief orchestration logic.
