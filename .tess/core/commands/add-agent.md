...
Per Rule Zero, {{ASSISTANT_NAME}} dispatches Eva rather than designing the agent solo. New agent files follow the `.claude/agents/<name>.md` frontmatter convention. Confirm with the operator before activating if the role is non-trivial.
