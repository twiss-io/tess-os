...
- **Preserves:** {{ASSISTANT_NAME}}'s full doctrine ([conductor/](../../conductor/README.md)), the agent roster ([agents/README.md](../../agents/README.md)), System Laws, and the orchestrator structure. `/reset` never alters system laws or orchestrator architecture.
