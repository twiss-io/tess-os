...
### Outcome Principle
Guilds are specialist resources.  
Outcomes determine orchestration.

---

## 2. Outcome Owner Rule

Every serious mission must have one clearly designated outcome owner.

The outcome owner is responsible for:
- holding the real objective
- deciding what guilds are needed
- keeping the mission aligned to the intended result
- resolving ambiguity in scope
- preventing committee sprawl
- ensuring the final synthesis serves the outcome, not just the participating guilds
...
### One-Owner Rule
No serious mission should proceed with multiple equal owners.

---

## 3. Guild Participation Roles

Every activated guild must be assigned one of the following roles:

### Owner
The guild most central to the outcome.

### Core Contributor
A guild materially necessary to solve the mission well.

### Reviewer
A guild activated to pressure-test, critique, or validate.

### Control / Challenge
A guild activated to assess evidence, risk, compliance, trust, or quality.

### Standby
A guild relevant enough to keep available, but not yet active.

### Participation Principle
No guild should be activated without a defined role.
...
- because cross-functional activity feels sophisticated

### Stay-Out Principle
A guild that does not materially improve the decision should remain out.
...
- active guilds
- role of each guild
- what each guild is responsible for contributing
- what each guild is not responsible for
- where control and challenge come from
- when escalation is required

### Mixed-Mission Principle
Cross-guild work must increase clarity, not create diffusion.
...
3. comparing the positions against:
   - business impact
   - execution reality
   - risk
   - reversibility
...
It is harmful when it is left structurally unresolved.
...
### Product + Coding + Analytics
For product design, validation, and build logic

### Brand + Creative + Events + Sales
For launches, showcases, and reveal-driven conversion

### CX + Sales + Growth
For renewal, expansion, referral, and retention loops

### Legal + Transactions + Finance
For major deals, structures, and negotiation-sensitive decisions

### Ops + People + Strategy
For organisational redesign, scaling, or leadership structure decisions

### Pattern Principle
Use known collaboration patterns when they serve the outcome, but never mechanically.
...
- Legal and risk challenge
- Analytics and signal-quality challenge
- QA and review challenge
- Founder's office challenge

### Control Principle
Important missions should not rely only on builders and recommenders.  
They should include challenge where cost of error is meaningful.
...
- risk and opportunity are both material
- the mission affects founder-level priorities
...
- better judgment
- stronger movement toward the desired result
