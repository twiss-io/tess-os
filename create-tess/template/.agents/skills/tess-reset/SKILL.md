...
<!-- Rendered by `tessctl render --target codex` from .tess/core/commands/reset.md. Regenerate; do not hand-edit. -->

Tess OS command `/reset`, packaged as an Agent Skill. Run it only when the user asks for it by name (`$tess-reset` in Codex).
