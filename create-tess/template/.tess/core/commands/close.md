...
3. **Log session work** to `kb/wiki/log.md` and any relevant `kb/wiki/missions/` entry — wiki is {{ASSISTANT_NAME}}-maintained, never edited by humans (Knowledge Base Framework).
