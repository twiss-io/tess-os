...
- **2026-06-27 Phase 0 cleanup** — Removed the dangling `l99-merge-discipline.md` link: the file was indexed (and a prior changelog claimed it had been "added") but never existed. The row is retained as a de-linked standing-authority note; documented playbook files corrected to 5. No file fabricated. Source: an internal review of the starter (broken doctrine-index links; not shipped with Tess OS).
