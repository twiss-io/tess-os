...
A lens is a short expertise brief the conductor loads into a role's dispatch when the task needs it. Lenses are not agents: they are never registered, never dispatched on their own, and never widen a role's permissions. The ten roles are in `conductor/roster.md`.
