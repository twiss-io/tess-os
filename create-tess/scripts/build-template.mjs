...
// The fix: ship the template FILES inside the npm package itself and
...
// the git tag and this bundle carry the same bytes and tess.lock needs no
// re-pin at build time.
