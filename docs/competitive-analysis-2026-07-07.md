...
1. **The harness > model finding is now measured.** Terminal-Bench 2.1 (June
   2026): identical GPT-5.5 scores 83.4% in Codex CLI vs 76.4% in Terminus 2 —
   a 7-point harness gap; SWE-bench scaffolding differences commonly swing
   10–20 pp. This is literally Tess-OS's thesis, quantified by third parties —
   and Tess-OS has zero published numbers of its own.
